...
public class Promise<T> {
	 ...
	 */
	//we want to avoid exception of 2 threads that want to resolve the same Object
	 ...
	 */
	// we want to avoid the case of 2 threads calling the same callback, thats why its synchronized
